...
trait TimeLikeSpec[T <: TimeLike[T]] extends WordSpec with Matchers {
  ...
  "Top" should  {
    ...
    "more or less equals only to itself" in {
      Top.moreOrLessEquals(Top, Duration.Top) shouldBe true
      Top.moreOrLessEquals(Top, Duration.Zero) shouldBe true
      Top.moreOrLessEquals(Bottom, Duration.Top) shouldBe true
      Top.moreOrLessEquals(Bottom, Duration.Zero) shouldBe false
      Top.moreOrLessEquals(fromSeconds(0), Duration.Top) shouldBe true
      Top.moreOrLessEquals(fromSeconds(0), Duration.Bottom) shouldBe false
    }
  ...
  "Bottom" should  {
    ...
    "more or less equals only to itself" in {
      Bottom.moreOrLessEquals(Bottom, Duration.Top) shouldBe true
      Bottom.moreOrLessEquals(Bottom, Duration.Zero) shouldBe true
      Bottom.moreOrLessEquals(Top, Duration.Bottom) shouldBe false
      Bottom.moreOrLessEquals(Top, Duration.Zero) shouldBe false
      Bottom.moreOrLessEquals(fromSeconds(0), Duration.Top) shouldBe true
      Bottom.moreOrLessEquals(fromSeconds(0), Duration.Bottom) shouldBe false
    }
  ...
  "Undefined" should  {
    ...
    "not more or less equal to anything" in {
      Undefined.moreOrLessEquals(Undefined, Duration.Top) shouldBe false
      Undefined.moreOrLessEquals(Undefined, Duration.Zero) shouldBe false
      Undefined.moreOrLessEquals(Top, Duration.Undefined) shouldBe true
      Undefined.moreOrLessEquals(Top, Duration.Zero) shouldBe false
      Undefined.moreOrLessEquals(fromSeconds(0), Duration.Top) shouldBe false
...
class TimeSpec extends  { val ops = Time } with TimeLikeSpec[Time] {
  "Time" should  {
    ...
    "moreOrLessEquals" in {
      val now = Time.now
      now.moreOrLessEquals(now + 1.second, 1.second) shouldBe true
      now.moreOrLessEquals(now - 1.seconds, 1.second) shouldBe true
      now.moreOrLessEquals(now + 2.seconds, 1.second) shouldBe false
      now.moreOrLessEquals(now - 2.seconds, 1.second) shouldBe false
    }
